        ...
        <div>
            <div className="h-screen flex flex-col justify-center items-center md:flex-row gap-2 md:justify-center m-10 ">
                ...
                <div className="w-full md:w-1/2 p-4 flex flex-col gap-4 items-center justify-center ">
                    ...
                    <p className="text-lg text-left md:text-left md:text-2xl font-extralight">Affordable rates, flexible rentals, and a wide selection of vehicles to fit your needs. Reserve your car in minutes and hit the road with confidence.</p>
                ...
                <div className="flex justify-center size-[85%] md:items-center md:justify-start md:size-[40%]">
                    <Image src={HeroImage} alt='hero-image' className="object-contain w-fit" priority />
                </div>
